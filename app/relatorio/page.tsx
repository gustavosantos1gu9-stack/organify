...
export default function RelatorioDashboardPublic() {
  return (
    <Suspense fallback={<div style={{ display: "flex", justifyContent: "center", padding: 60 }}><Loader2 size={32} className="spin" style={{ color: "#29ABE2" }} /></div>}>
      <DashboardContent />
    </Suspense>
  );
}
