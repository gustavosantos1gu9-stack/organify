...
export default function CategoriasSaidaPage() {
  ...
  const { data: categorias, loading: loadingCategorias, refresh } = useCategoriasFinanceiras("saida");
  ...
  const handleSalvar = async () => {
    ...
    try {
      if (editando) {
        ...
        await criarCategoriaFinanceira(nome.trim(), "saida");
      }
      refresh();
      setShowModal(false);
      setEditando(null);
  ...
  return (
    <div className="animate-in">
      <div className="breadcrumb">
        ...
        <span className="current">Categorias de saída</span>
      </div>
      <h1 style={{ fontSize: "22px", fontWeight: "600", marginBottom: "24px" }}>Categorias de saída</h1>
        ...
        <div style={{ padding: "16px", display: "flex", gap: "12px", borderBottom: "1px solid #2e2e2e" }}>
          <div style={{ position: "relative", flex: 1 }}>
            ...
            <input
              ...
              placeholder="Buscar tipos de saída..."
              value={busca}
          ...
          <div className="modal animate-in" style={{ maxWidth: "400px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
              <h2 style={{ fontSize: "16px", fontWeight: "600" }}>
                {editando ? "Editar categoria de saída" : "Cadastrar categoria de saída"}
              </h2>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="Ex: Contabilidade, Escritório..."
                value={nome}
                onChange={(e) => setNome(e.target.value)}
              />
              <p style={{ fontSize: "11px", color: "#606060", marginTop: "6px" }}>
                Adicione uma categoria de saída ex: Reembolso de cliente, escritório de contabilidade.
              </p>
            </div>
