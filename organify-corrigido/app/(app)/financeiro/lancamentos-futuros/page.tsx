...
import { useLancamentosFuturos, criarLancamentoFuturo, removerLancamento, useClientes, supabase, getAgenciaId } from "@/lib/hooks";
...
export default function LancamentosFuturosPage() {
  ...
  const handleLancar = async (id: string, valorRecebido: number) => {
    try {
      ...
      refresh();
    } catch(e){ console.error(e); alert("Erro ao lançar"); }
  };
