                          ...
                          <div key={child.label}>
                            <button
                              ...
                              style={{
                                ...
                                background: hasActiveSub ? "#22c55e10" : "transparent",
                                border: "none",
                              ...
                              <div style={{ marginLeft: "12px", display: "flex", flexDirection: "column", gap: "1px" }}>
                                {child.children.map((sc) => (
                                  <Link key={sc.href} href={sc.href} style={{
                                    ...
                                    background: isActive(sc.href) ? "#22c55e15" : "transparent",
                                    textDecoration: "none",
                                    borderLeft: isActive(sc.href) ? "2px solid #22c55e" : "2px solid transparent",
                                  }}>
                                    {sc.label}
                                  </Link>
                                ))}
